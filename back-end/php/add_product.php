...
if(!empty($_POST)){
    ...
    if(!$flag){
        ...
        $query = "INSERT INTO Produtos(nome, categoria, descricao, preco, promocao, stock) 
        VALUES ('$nome', '$categoria', '$descricao','$preco', $promocao, '$quantidade')";
        ...
        $id_produto = mysqli_insert_id($myDB); //Retorna o valor do id da última entrada inserida na tabela

        $queryVenda = "INSERT INTO Venda(id_produto, id_users) VALUES ('$id_produto', '$id_user')";
        ...
        if(!$resultVenda){
            ...
            header("Location: add_image.php?id=".$id_produto);
            die();
        }
...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <div class="form-box">
                <p class="form-title">Adicionar novo produto</p>
